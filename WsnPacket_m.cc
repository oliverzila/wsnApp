...
WsnPacket::WsnPacket() : ::inet::FieldsChunk()
{
}

WsnPacket::WsnPacket(const WsnPacket& other) : ::inet::FieldsChunk(other)
{
    copy(other);
}
...
uint32_t WsnPacket::getSequenceNumber() const
{
    return this->sequenceNumber;
}

void WsnPacket::setSequenceNumber(uint32_t sequenceNumber)
{
    handleChange();
...
WsnPacketDescriptor::WsnPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::WsnPacket)), "inet::FieldsChunk")
{
...
unsigned int WsnPacketDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_xPosition
        FD_ISEDITABLE,    // FIELD_yPosition
    };
...
int WsnPacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0] == 'x' && strcmp(fieldName, "xPosition") == 0) return base+1;
    if (fieldName[0] == 'y' && strcmp(fieldName, "yPosition") == 0) return base+2;
...
int WsnPacketDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *WsnPacketDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string WsnPacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool WsnPacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *WsnPacketDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
