...
#ifndef __INET_IEEE802154MACFREQ_H
#define __INET_IEEE802154MACFREQ_H
 ...
 */
class INET_API Ieee802154MacFreq : public MacProtocolBase, public IMacProtocol
{
  public:
    Ieee802154MacFreq()
        : MacProtocolBase()
  ...
  protected:
    ...
    /** @brief The number of maximum allocation timer reset broadcast.*/
  ...
  private:
     ...
     */
    Ieee802154MacFreq(const Ieee802154MacFreq&);
    /** @brief Assignment operator is not allowed.
     */
    Ieee802154MacFreq& operator=(const Ieee802154MacFreq&);
};

} // namespace inet

#endif // ifndef __INET_IEEE802154MACFREQ_H
